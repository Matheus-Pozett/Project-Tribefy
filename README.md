...
- Data para entrega final do projeto:`12/06/2024 23:59`.
...
- Instale as dependências [**Caso existam**] com `npm install`
    ...
    - Cada requisito deve estar em um arquivo e cada arquivo deve ter o nome `n_challenge.sql`, onde `n` é o número do requisito.
...
- Use o comando: `git clone git@github.com:tryber/sd-039-project-trybefy.git`
...
> Atenção ⚠️: As alterações feitas nos requisitos 6 e 7 são ignoradas pelo avaliador. Quando for testar manualmente, considere os dados da forma que foram inseridos no requisito 2.
...
- Será validado se os apelidos das colunas foram aplicados como pedido;
- Será validado se os dados foram ordenados como pedido;
- Será validado que a query deve continuar retornando os dados ordenados corretamente, mesmo ao inserir um novo álbum;
- Será validado se o resultado esperado é equivalente ao abaixo:
...
[Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH39&template=betrybe/sd-0x-project-trybefy)
